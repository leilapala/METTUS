...
const App = () => {
  ...
  return (
    <div className="app">
      <Header />
      <Navigation />
      <ProductCarousel category="🔥⌛🔥LAST CHANCE🔥⌛🔥" products={products.filter(product => product.categoryId === 1)} />
      <ProductCarousel category="Corset" products={products.filter(product => product.categoryId === 6)} />
